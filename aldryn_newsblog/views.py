...
class EditModeMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        self.edit_mode = (
            getattr(self.request, 'toolbar', None) and toolbar_edit_mode_active(self.request))
...
class ArticleSearchResultsList(ArticleListBase):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.edit_mode = (getattr(self.request, 'toolbar', None) and toolbar_edit_mode_active(request))
